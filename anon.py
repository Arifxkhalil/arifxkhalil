...
jalan("   \033[1;93m Welcome to Anonynomous ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mBlacktiger\033[1;96m•◈•──────────•◈•")

CorrectUsername = "anon77"
CorrectPassword = "anon77"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://m.youtube.com/channel/UCLI79D9dqlqpWQa2PCjGtRg ')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-openh ttps://m.youtube.com/channel/UCLI79D9dqlqpWQa2PCjGtRg ')
...
def pilih_super():
	...
	jalan('                    \033[1;97Anonymous start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
